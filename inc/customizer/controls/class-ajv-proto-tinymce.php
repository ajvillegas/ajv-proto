...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	class AJV_Proto_TinyMCE extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'ajv_proto_custom_controls_js', AJV_PROTO_INC . "/customizer/assets/js/customizer{$suffix}.js", array( 'jquery', 'jquery-ui-core' ), AJV_PROTO_THEME_VERSION, true );
			wp_enqueue_style( 'ajv_proto_custom_controls_css', AJV_PROTO_INC . "/customizer/assets/css/customizer{$suffix}.css", array(), AJV_PROTO_THEME_VERSION, 'all' );
			wp_enqueue_editor();
